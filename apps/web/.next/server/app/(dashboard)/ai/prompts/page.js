(() => {
  ...
  ((a.id = 869),
    ...
    (a.modules = {
      ...
      4387: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 95454));
      },
      6533: (a, b, c) => {
        "use strict";
      ...
      18459: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 17484));
      },
      19121: (a) => {
        "use strict";
      ...
      69398: (a, b, c) => {
        ...
        let I = {
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/ai/prompts/page",
              pathname: "/ai/prompts",
              bundlePath: "",
              filename: "",
              appPaths: [],
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/ai/prompts/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      95454: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/ai/prompts/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/ai/prompts/page.tsx",
          "default",
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 69398)));
  module.exports = c;
})();
