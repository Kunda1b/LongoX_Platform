    ...
    (a.modules = {
      ...
      30007: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/ai/models/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      64966: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 30007));
      },
      66715: (a, b, c) => {
        "use strict";
      ...
      87142: (a, b, c) => {
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/ai/models/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 87142)));
  module.exports = c;
})();
