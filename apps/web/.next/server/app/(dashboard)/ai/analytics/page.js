    ...
    (a.modules = {
      ...
      5280: (a, b, c) => {
        ...
        let I = {
                          ...
                          "analytics",
                          {
                            children: [
                              ...
                              {},
                              {
                                page: [
                                  () =>
                                    Promise.resolve().then(c.bind(c, 96377)),
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/ai/analytics/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/ai/analytics/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      47540: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 77591));
      },
      49170: (a, b, c) => {
        "use strict";
        c.d(b, { $: () => j });
      ...
      96377: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/ai/analytics/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/ai/analytics/page.tsx",
          "default",
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 5280)));
  module.exports = c;
})();
