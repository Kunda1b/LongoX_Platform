(() => {
  ...
  ((a.id = 250),
    ...
    (a.modules = {
      ...
      582: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 36693));
      },
      3295: (a) => {
        "use strict";
      ...
      36693: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/billing/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      61262: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 61392));
      },
      61392: (a, b, c) => {
        "use strict";
                      ...
                      (0, d.jsxs)(e.Wu, {
                        children: [
                          ...
                          (0, d.jsxs)(g.$, {
                            ...
                            className: "mt-3",
                            children: [
                              (0, d.jsx)(i, { className: "mr-1 h-4 w-4" }),
                              " Upgrade",
                            ],
                          }),
                        ],
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 47070)));
  module.exports = c;
})();
