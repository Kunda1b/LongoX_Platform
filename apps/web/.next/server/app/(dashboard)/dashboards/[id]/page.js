(() => {
  ...
  ((a.id = 180),
    ...
    (a.modules = {
      ...
      20980: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 22161));
      },
      22161: (a, b, c) => {
        "use strict";
                    ...
                    children: [
                      ...
                      (0, d.jsx)(f.Wu, {
                        children: (0, d.jsx)("div", {
                          ...
                          children: [30, 50, 80, 45, 70, 60, 90].map((a, b) =>
                            (0, d.jsxs)(
                              "div",
                              {
                                className:
                                ...
                                children: [
                                  (0, d.jsx)("div", {
                                    className:
                                      "w-full rounded-md bg-primary/20",
                                    style: { height: `${a}px` },
                                  }),
                                  (0, d.jsx)("span", {
      ...
      22658: (a, b, c) => {
        ...
        let I = {
                          ...
                          "[id]",
                          {
                            children: [
                              ...
                              {},
                              {
                                page: [
                                  () =>
                                    Promise.resolve().then(c.bind(c, 72875)),
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/dashboards/[id]/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/dashboards/[id]/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      72875: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dashboards/[id]/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dashboards/[id]/page.tsx",
          "default",
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 22658)));
  module.exports = c;
})();
