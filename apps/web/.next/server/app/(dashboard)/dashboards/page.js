(() => {
  ...
  ((a.id = 334),
    ...
    (a.modules = {
      ...
      7406: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 27617));
      },
      10846: (a) => {
        "use strict";
      ...
      27617: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dashboards/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      47158: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 99251));
      },
      49170: (a, b, c) => {
        "use strict";
        c.d(b, { $: () => j });
      ...
      60848: (a, b, c) => {
        ...
        let I = {
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/dashboards/page",
              pathname: "/dashboards",
              bundlePath: "",
              filename: "",
              appPaths: [],
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/dashboards/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
                        ...
                        (0, d.jsxs)(e.Wu, {
                          ...
                          children: [
                            (0, d.jsx)("span", {
                              ...
                              children: a.lastModified,
                            }),
                            (0, d.jsx)(f.E, {
                              variant: a.shared ? "info" : "secondary",
                              children: a.shared ? "Shared" : "Private",
                            }),
                          ],
                        }),
                      ],
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 60848)));
  module.exports = c;
})();
