    ...
    (a.modules = {
      ...
      12463: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/settings/regions/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      13662: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 53413));
      },
      19121: (a) => {
        "use strict";
                      ...
                      children: [
                        ...
                        (0, d.jsxs)(e.Wu, {
                          ...
                          children: [
                            (0, d.jsx)(f.E, {
                              variant:
                                "healthy" === a.status ? "success" : "warning",
                              children: a.status,
                            }),
                            (0, d.jsx)("span", {
      ...
      73750: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 12463));
      },
      74560: (a, b, c) => {
        "use strict";
        (c.r(b),
        ...
        let I = {
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/settings/regions/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/settings/regions/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 74560)));
  module.exports = c;
})();
