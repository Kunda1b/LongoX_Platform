    ...
    (a.modules = {
      ...
      61628: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/credentials/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      73456: (a, b, c) => {
        ...
        let I = {
                    ...
                    children: [
                      "credentials",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 61628)),
                              "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/credentials/page.tsx",
                            ],
                          },
                        ],
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/credentials/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/credentials/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      89159: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 44938));
      },
      97663: (a, b, c) => {
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 73456)));
  module.exports = c;
})();
