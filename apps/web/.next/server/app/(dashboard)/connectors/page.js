(() => {
  ...
  ((a.id = 527),
    ...
    (a.modules = {
      ...
      16427: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 96759));
      },
      19121: (a) => {
        "use strict";
      ...
      50550: (a, b, c) => {
        ...
        let I = {
                    ...
                    children: [
                      "connectors",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 95964)),
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/connectors/page",
              pathname: "/connectors",
              bundlePath: "",
              filename: "",
              appPaths: [],
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/connectors/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      95964: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/connectors/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/connectors/page.tsx",
          "default",
            ...
            children: [
              (0, d.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, d.jsxs)(g.$, {
                    children: [
                      (0, d.jsx)(h.A, { className: "mr-1 h-4 w-4" }),
                      " Add Connector",
                    ],
                  }),
                ],
                      ...
                      children: [
                        (0, d.jsxs)(e.aR, {
                          ...
                          children: [
                            ...
                            (0, d.jsx)(i, {
                              className: `h-4 w-4 ${"connected" === a.status ? "text-emerald-500" : "error" === a.status ? "text-destructive" : "text-muted-foreground"}`,
                            }),
                          ],
                        }),
                        (0, d.jsx)(e.Wu, {
                          children: (0, d.jsx)(f.E, {
                            variant:
                              "connected" === a.status
                                ? "success"
                                : "error" === a.status
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 50550)));
  module.exports = c;
})();
