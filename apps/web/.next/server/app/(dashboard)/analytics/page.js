    ...
    (a.modules = {
      ...
      22794: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/analytics/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      57792: (a, b, c) => {
                    ...
                    children: [
                      "analytics",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 22794)),
                              "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/analytics/page.tsx",
                            ],
                          },
                        ],
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/analytics/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      83877: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 96291));
      },
      86439: (a) => {
        "use strict";
                ...
                children: [
                  ...
                  (0, d.jsx)(e.Wu, {
                    children: (0, d.jsx)("div", {
                      ...
                      children: [40, 70, 55, 90, 65, 80, 45].map((a, b) =>
                        (0, d.jsxs)(
                          "div",
                          {
                            className:
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 57792)));
  module.exports = c;
})();
