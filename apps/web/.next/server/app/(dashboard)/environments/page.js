(() => {
  ...
  ((a.id = 401),
    ...
    (a.modules = {
      ...
      44009: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 45260));
      },
      45260: (a, b, c) => {
        "use strict";
      ...
      47618: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/environments/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      78857: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 47618));
      },
      82466: (a, b, c) => {
        "use strict";
      ...
      88022: (a, b, c) => {
        ...
        let I = {
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/environments/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/environments/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 88022)));
  module.exports = c;
})();
