(() => {
  ...
  ((a.id = 690),
    ...
    (a.modules = {
                  ...
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      (0, d.jsxs)(h.$, {
                        ...
                        size: "sm",
                        children: [
                          (0, d.jsx)(i.A, { className: "mr-1 h-4 w-4" }),
                          " Retry",
                        ],
                      }),
                      (0, d.jsxs)(h.$, {
                        ...
                        size: "sm",
                        children: [
                          (0, d.jsx)(j, { className: "mr-1 h-4 w-4" }),
                          " Cancel",
                        ],
                      }),
                    ],
                            ...
                            children: (0, d.jsxs)("div", {
                              ...
                              children: [
                                (0, d.jsxs)("div", {
                                  ...
                                  children: [
                                    (0, d.jsx)("div", {
                                      className: `flex h-6 w-6 items-center justify-center rounded-full text-xs font-bold text-white ${"completed" === a.status ? "bg-emerald-500" : "bg-destructive"}`,
                                      children:
                                        "completed" === a.status ? "✓" : "✗",
                                    }),
                                    (0, d.jsxs)("div", {
      ...
      37826: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 23310));
      },
      41025: (a) => {
        "use strict";
      ...
      52237: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/executions/[id]/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      54958: (a, b, c) => {
        ...
        let I = {
                          ...
                          "[id]",
                          {
                            children: [
                              ...
                              {},
                              {
                                page: [
                                  () =>
                                    Promise.resolve().then(c.bind(c, 52237)),
                                  "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/executions/[id]/page.tsx",
                                ],
                              },
                            ],
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/executions/[id]/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/executions/[id]/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 54958)));
  module.exports = c;
})();
