(() => {
  ...
  ((a.id = 483),
    ...
    (a.modules = {
      ...
      14859: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 60832));
      },
      15671: (a, b, c) => {
        "use strict";
        c.d(b, { A: () => d });
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      60832: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/rbac/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/rbac/page.tsx",
          "default",
      ...
      67837: (a, b, c) => {
        ...
        let k = [
          { name: "Admin", users: 3, permissions: "Full access" },
          {
            name: "Editor",
            users: 8,
            permissions: "Create and edit workflows",
          },
                  ...
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      (0, d.jsxs)(g.$, {
                        variant: "outline",
                        children: [
                          (0, d.jsx)(h, { className: "mr-1 h-4 w-4" }),
                          " Invite User",
                        ],
                      }),
                      (0, d.jsxs)(g.$, {
      ...
      90883: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 67837));
      },
      97663: (a, b, c) => {
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 34666)));
  module.exports = c;
})();
