    ...
    (a.modules = {
                  ...
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      (0, d.jsxs)(e.$, {
                        ...
                        size: "sm",
                        children: [
                          (0, d.jsx)(g.A, { className: "mr-1 h-4 w-4" }),
                          " Retry All",
                        ],
                      }),
                      (0, d.jsxs)(e.$, {
                    ...
                    (0, d.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          (0, d.jsx)("div", {
                            className:
                              "col-span-2 text-muted-foreground text-xs",
                            children: a.date,
                          }),
                          (0, d.jsxs)("div", {
      ...
      30589: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dlq/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
                    ...
                    children: [
                      "dlq",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 30589)),
                              "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dlq/page.tsx",
                            ],
                          },
                        ],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      56882: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 1783));
      },
      63033: (a) => {
        "use strict";
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 33874)));
  module.exports = c;
})();
