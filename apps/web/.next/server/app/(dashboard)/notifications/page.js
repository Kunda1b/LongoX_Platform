    ...
    (a.modules = {
      ...
      2720: (a, b, c) => {
                    ...
                    children: [
                      "notifications",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 91918)),
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/notifications/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
                  ...
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, d.jsx)(f.$, {
                        variant: "outline",
                        size: "sm",
                        children: (0, d.jsx)(i.A, { className: "h-4 w-4" }),
                      }),
                    ],
                  }),
                ],
              ...
              (0, d.jsx)("div", {
                ...
                children: j.map((a, b) =>
                  (0, d.jsx)(
                    e.Zp,
                    {
                      className: a.read ? "" : "border-primary/30",
      ...
      91918: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/notifications/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/notifications/page.tsx",
          "default",
      ...
      94121: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 64156));
      },
      97663: (a, b, c) => {
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 2720)));
  module.exports = c;
})();
