    ...
    (a.modules = {
      ...
      19340: (a, b, c) => {
        ...
        let I = {
                    ...
                    children: [
                      "webhook-endpoints",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 84052)),
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/webhook-endpoints/page",
              pathname: "/webhook-endpoints",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/webhook-endpoints/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      38635: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 63034));
      },
      39694: (a, b, c) => {
        "use strict";
        c.d(b, { A: () => d });
        let d = (0, c(23048).A)("copy", [
          [
            "rect",
            {
              width: "14",
                      ...
                      children: [
                        ...
                        (0, d.jsxs)(e.Wu, {
                          ...
                          children: [
                            (0, d.jsx)(f.E, {
                              variant:
                                "active" === a.status ? "success" : "secondary",
                              children: a.status,
                            }),
                            (0, d.jsxs)("div", {
                              className: "flex items-center gap-2",
      ...
      84052: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/webhook-endpoints/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/webhook-endpoints/page.tsx",
          "default",
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 19340)));
  module.exports = c;
})();
