(() => {
  ...
  ((a.id = 838),
    ...
    (a.modules = {
      ...
      3790: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 84574));
      },
      6533: (a, b, c) => {
        "use strict";
      ...
      34054: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 47913));
      },
      41025: (a) => {
        "use strict";
      ...
      47913: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/builder/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      84574: (a, b, c) => {
        ...
        var d = c(78157),
          ...
          g = c(12142),
          h = c(21041);
        let i = (0, c(23048).A)("grip-vertical", [
                      ...
                      children: (0, d.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, d.jsxs)(f.$, {
                            ...
                            className: "mt-4",
                            children: [
                              (0, d.jsx)(k.A, { className: "mr-1 h-4 w-4" }),
                              " Add Trigger",
                            ],
                          }),
                        ],
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 77418)));
  module.exports = c;
})();
