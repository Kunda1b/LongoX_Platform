(() => {
  ...
  ((a.id = 337),
    ...
    (a.modules = {
      ...
      7705: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 37132));
      },
      10846: (a) => {
        "use strict";
      ...
      21450: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/dashboard/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      37132: (a, b, c) => {
        ...
        var d = c(78157),
          ...
          h = c(59730),
          i = c(30910);
        let j = (0, c(23048).A)("triangle-alert", [
          [
            "path",
            {
                              ...
                              "div",
                              {
                                ...
                                children: [
                                  (0, d.jsxs)("div", {
                                    ...
                                    children: [
                                      (0, d.jsx)("div", {
                                        className: `h-2 w-2 rounded-full ${"active" === a.status ? "bg-emerald-500" : "bg-amber-500"}`,
                                      }),
                                      (0, d.jsx)("span", {
                                        className: "text-sm",
                                        children: a.name,
      ...
      71257: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 21450));
      },
      82466: (a, b, c) => {
        "use strict";
      ...
      84084: (a, b, c) => {
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/dashboard/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 84084)));
  module.exports = c;
})();
