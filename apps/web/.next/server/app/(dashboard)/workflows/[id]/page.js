    ...
    (a.modules = {
      ...
      45074: (a, b, c) => {
        ...
        let I = {
                          ...
                          "[id]",
                          {
                            children: [
                              ...
                              {},
                              {
                                page: [
                                  () =>
                                    Promise.resolve().then(c.bind(c, 40084)),
                                  "/home/ubuntu/repos/Flow-Builder-Nexus/apps/web/src/app/(dashboard)/workflows/[id]/page.tsx",
                                ],
                              },
                            ],
          ...
          L = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/(dashboard)/workflows/[id]/page",
        ...
        async function M(a, b, d) {
          var D;
          let H = "/(dashboard)/workflows/[id]/page";
          "/index" === H && (H = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      72239: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 92291));
      },
      82466: (a, b, c) => {
        "use strict";
                  ...
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, d.jsxs)(h.$, {
                        ...
                        size: "sm",
                        children: [
                          (0, d.jsx)(k, { className: "mr-1 h-4 w-4" }),
                          " Pause",
                        ],
                      }),
                      (0, d.jsxs)(h.$, {
                        size: "sm",
                        children: [
                          (0, d.jsx)(l.A, { className: "mr-1 h-4 w-4" }),
                          " Run",
                        ],
                      }),
                      (0, d.jsx)(h.$, {
                        variant: "destructive",
                        size: "sm",
                        children: (0, d.jsx)(m.A, { className: "h-4 w-4" }),
                      }),
                    ],
                  }),
                ],
  ...
  b.C(a);
  var c = b.X(0, [474, 85, 360], () => b((b.s = 45074)));
  module.exports = c;
})();
