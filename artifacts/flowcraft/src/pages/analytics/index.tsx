...
export default function Analytics() {
  const { data: execAnalytics = [], isLoading: isLoadingExec } =
    useGetExecutionAnalytics({ days: 14 });
  const { data: wfAnalytics = [], isLoading: isLoadingWf } =
    useGetWorkflowAnalytics();
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Monitor automation performance and workflow reliability.
        </p>
      </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-muted-foreground bg-muted/50 uppercase border-y border-border">
              <tr>
                ...
                <th className="px-6 py-4 font-medium text-right text-green-600">
                  Success
                </th>
                <th className="px-6 py-4 font-medium text-right text-red-600">
                  Failed
                </th>
