import { useGetAppStats } from "@longox/api-client-react";
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Usage and overview across all internal tools.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          title="Total Apps"
          value={isLoading ? null : stats?.totalApps}
        />
        <StatCard
          title="Published"
          value={isLoading ? null : stats?.publishedApps}
        />
        <StatCard title="Drafts" value={isLoading ? null : stats?.draftApps} />
        <StatCard
          title="Total Views"
          value={isLoading ? null : stats?.totalViews}
        />
      </div>
