...
import { createSseWriter, realtimeHub } from "@autoflow/shared-realtime";
import { authMiddleware } from "../lib/auth";

const router = Router();

router.get("/realtime/events", authMiddleware, (req: Request, res: Response) => {
...
router.get("/realtime/executions/:id", authMiddleware, (req: Request, res: Response) => {
  ...
  client.send("connected", { executionId, message: "Monitoring execution updates" });
