...
const CONNECTOR_SEEDS: ConnectorSeed[] = [
  {
    ...
    color: "#FF7A59",
    description:
      "Connect to HubSpot CRM to manage contacts, deals, companies, and marketing campaigns across your organization.",
    icon: "H",
    ...
    actions: [
      ...
      },
      {
        ...
        inputSchema: {
          type: "object",
          properties: { dealId: { type: "string" }, stage: { type: "string" } },
      ...
      },
      {
        ...
        description: "Send a marketing email to a contact via HubSpot",
        inputSchema: {
          type: "object",
          properties: {
            contactId: { type: "string" },
            emailId: { type: "string", description: "Email template ID" },
          },
          required: ["contactId", "emailId"],
        },
        outputSchema: {
          type: "object",
          properties: {
      ...
      },
      {
        actionId: "add_note",
        name: "Add Note",
        description: "Add a note to a contact, deal or company",
        inputSchema: {
          type: "object",
          properties: {
          ...
          required: ["associatedId", "associatedType", "note"],
        },
        outputSchema: {
          type: "object",
    ...
    triggers: [
      ...
      },
      {
        ...
        config: { event: "deal.propertyChange.dealstage" },
      },
      {
        triggerId: "form_submitted",
        triggerType: "webhook",
        name: "Form Submitted",
        description: "Fires when a HubSpot form is submitted",
        config: { event: "form.submission" },
      },
      {
        triggerId: "contact_updated",
        triggerType: "polling",
        name: "Contact Updated",
        description: "Polls for recently updated contacts",
        config: {},
        pollingInterval: 300,
      },
    ],
  },
  {
    ...
    color: "#4A154B",
    description:
      "Send messages, create channels, and respond to events in Slack. The leading team communication platform.",
    icon: "S",
    certificationLevel: "official",
    authType: "oauth2",
    isInstalled: false,
  ...
  },
  {
    ...
    color: "#635BFF",
    description:
      "Accept payments, manage subscriptions, and handle refunds using Stripe's comprehensive payments infrastructure.",
    icon: "St",
    certificationLevel: "official",
    authType: "apikey",
    isInstalled: true,
    ...
    actions: [
      ...
      },
      {
        ...
        name: "Create Charge",
        description: "Create a one-time payment charge",
        inputSchema: {
          type: "object",
          properties: {
      ...
      {
        actionId: "update_customer",
        name: "Update Customer",
        description: "Update a customer's billing details",
        inputSchema: {
          type: "object",
          properties: {
            customerId: { type: "string" },
    ...
    triggers: [
      {
        ...
        config: { event: "payment_intent.succeeded" },
      },
      {
        ...
        config: { event: "payment_intent.payment_failed" },
      },
      {
        triggerId: "subscription_created",
        triggerType: "webhook",
        name: "Subscription Created",
        description: "Fires when a new subscription is created",
        config: { event: "customer.subscription.created" },
      },
    ],
  },
  {
    ...
    color: "#74AA9C",
    description:
      "Integrate GPT models, DALL-E image generation, and Whisper transcription into your automation workflows.",
    icon: "AI",
    certificationLevel: "official",
    authType: "apikey",
    isInstalled: true,
    ...
    actions: [
      {
        ...
        description: "Generate a response using GPT-4 or GPT-3.5",
        inputSchema: {
          type: "object",
          properties: {
            model: {
      ...
      {
        actionId: "create_embedding",
        name: "Create Embedding",
        description: "Generate a vector embedding for semantic search",
        inputSchema: {
          type: "object",
          properties: {
  ...
  },
  {
    ...
    color: "#336791",
    description:
      "Query, insert, update and delete records in any PostgreSQL database. Supports connection pooling and SSL.",
    icon: "Pg",
    certificationLevel: "official",
    authType: "apikey",
    isInstalled: false,
    ...
    actions: [
      {
        ...
        name: "Execute Query",
        description: "Run a raw SQL query and return results",
        inputSchema: {
          type: "object",
          properties: {
      ...
      },
      {
        ...
        outputSchema: {
          type: "object",
          properties: { id: { type: "string" }, inserted: { type: "object" } },
        },
      },
      {
        actionId: "update_row",
    ...
    triggers: [
      {
        ...
        triggerType: "polling",
        name: "New Row Added",
        description: "Polls for newly inserted rows in a table",
        config: { orderColumn: "created_at" },
        pollingInterval: 60,
      },
      {
        triggerId: "row_updated",
        triggerType: "polling",
        name: "Row Updated",
        description: "Polls for recently updated rows",
        config: { orderColumn: "updated_at" },
        pollingInterval: 60,
      },
    ],
  },
  {
    ...
    color: "#24292e",
    description:
      "Automate your GitHub workflows — create issues, open PRs, add comments, and respond to repository events.",
    icon: "GH",
    ...
    actions: [
      ...
      },
      {
        ...
        description: "Open a pull request between branches",
        inputSchema: {
          type: "object",
          properties: {
            owner: { type: "string" },
      ...
      },
      {
        ...
        outputSchema: {
          type: "object",
          properties: { sha: { type: "string" }, merged: { type: "boolean" } },
        },
      },
      {
        actionId: "create_branch",
        name: "Create Branch",
        description: "Create a new git branch from a ref",
        inputSchema: {
          type: "object",
          properties: {
            owner: { type: "string" },
    ...
    triggers: [
      {
        ...
        config: { event: "issues", action: "opened" },
      },
      {
        triggerId: "pr_opened",
        triggerType: "webhook",
        name: "Pull Request Opened",
        description: "Fires when a new PR is opened",
        config: { event: "pull_request", action: "opened" },
      },
      {
        triggerId: "push_event",
        triggerType: "webhook",
        name: "Code Pushed",
        description: "Fires when code is pushed to a branch",
        config: { event: "push" },
      },
      {
        triggerId: "release_published",
        triggerType: "webhook",
        name: "Release Published",
        description: "Fires when a new release is published",
        config: { event: "release", action: "published" },
      },
    ],
  },
  {
    ...
    color: "#00A1E0",
    description:
      "Connect to Salesforce to manage leads, opportunities, contacts, and run SOQL queries against your CRM data.",
    icon: "SF",
    certificationLevel: "verified",
    authType: "oauth2",
    isInstalled: false,
    ...
    actions: [
      ...
      {
        actionId: "update_opportunity",
        name: "Update Opportunity",
        description: "Update an opportunity's stage or amount",
        inputSchema: {
          type: "object",
          properties: {
      ...
      {
        actionId: "search_records",
        name: "Search Records (SOQL)",
        description: "Run a SOQL query against your Salesforce org",
        inputSchema: {
          type: "object",
          properties: {
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            whatId: {
              type: "string",
              description: "Opportunity or Account ID",
            },
            dueDate: { type: "string" },
      ...
      },
      {
        ...
        name: "Convert Lead",
        description: "Convert a lead to a contact and opportunity",
        inputSchema: {
          type: "object",
          properties: {
            leadId: { type: "string" },
    ...
    triggers: [
      {
        ...
        description: "Polls for newly created leads",
        config: {},
        pollingInterval: 300,
      },
      {
        triggerId: "opportunity_updated",
        triggerType: "polling",
        name: "Opportunity Updated",
        description: "Polls for recently updated opportunities",
        config: {},
        pollingInterval: 300,
      },
      {
        triggerId: "contact_created",
        triggerType: "webhook",
        name: "Contact Created",
        description: "Fires when a new contact is created via Apex trigger",
        config: {},
      },
    ],
  },
  {
    ...
    color: "#F22F46",
    description:
      "Send SMS, make voice calls, and send WhatsApp messages using Twilio's programmable communications platform.",
    icon: "Tw",
    certificationLevel: "verified",
    authType: "apikey",
    isInstalled: false,
    ...
    actions: [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            to: { type: "string" },
            from: { type: "string" },
            twimlUrl: { type: "string", description: "TwiML instructions URL" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            to: {
              type: "string",
              description: "WhatsApp number (whatsapp:+1...)",
            },
            from: { type: "string" },
            body: { type: "string" },
      ...
      {
        actionId: "get_call_status",
        name: "Get Call Status",
        description: "Check the status of an outbound call",
        inputSchema: {
          type: "object",
    ...
    triggers: [
      {
        triggerId: "incoming_sms",
        triggerType: "webhook",
        name: "Incoming SMS",
        description: "Fires when an SMS is received on your Twilio number",
        config: { event: "sms.received" },
      },
      {
        triggerId: "call_status_changed",
        triggerType: "webhook",
        name: "Call Status Changed",
        description:
          "Fires on call status updates (ringing, answered, completed)",
        config: { event: "call.statusCallback" },
      },
    ],
  },
  {
    ...
    color: "#0F9D58",
    description:
      "Read and write data to Google Sheets. Append rows, update cells, and trigger workflows from spreadsheet changes.",
    icon: "GS",
    certificationLevel: "official",
    authType: "oauth2",
    isInstalled: false,
    ...
    actions: [
      ...
      {
        actionId: "update_cell",
        name: "Update Cell",
        description: "Update a specific cell or range",
        inputSchema: {
          type: "object",
          properties: {
            spreadsheetId: { type: "string" },
        ...
        outputSchema: {
          type: "object",
          properties: { updatedRange: { type: "string" } },
        },
      },
      {
        actionId: "get_sheet_data",
        name: "Get Sheet Data",
        description: "Retrieve all data from a sheet or range",
        inputSchema: {
          type: "object",
          properties: {
            spreadsheetId: { type: "string" },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            rowIndex: { type: "number", description: "1-based row index" },
          },
    ...
    triggers: [
      {
        ...
        triggerType: "polling",
        name: "New Row Added",
        description: "Polls for newly appended rows in the spreadsheet",
        config: {},
        pollingInterval: 300,
      },
      {
        triggerId: "spreadsheet_updated",
        triggerType: "polling",
        name: "Spreadsheet Updated",
        description: "Polls for any changes to the spreadsheet",
        config: {},
        pollingInterval: 600,
      },
    ],
  },
  {
    ...
    color: "#0052CC",
    description:
      "Create and update Jira issues, transition tickets through workflows, and respond to sprint and project events.",
    icon: "Ji",
    certificationLevel: "verified",
    authType: "oauth2",
    isInstalled: false,
    ...
    actions: [
      {
        actionId: "create_issue",
        name: "Create Issue",
        description: "Create a new Jira issue (bug, story, task)",
        inputSchema: {
          type: "object",
          properties: {
      ...
      },
      {
        actionId: "get_issue",
        name: "Get Issue",
        description: "Retrieve full details of a Jira issue",
        inputSchema: {
          type: "object",
    ...
    triggers: [
      {
        ...
        triggerType: "webhook",
        name: "Issue Created",
        description: "Fires when a new issue is created in a project",
        config: { event: "jira:issue_created" },
      },
      {
        triggerId: "issue_updated",
        triggerType: "webhook",
        name: "Issue Updated",
        description: "Fires when an issue is updated or transitioned",
        config: { event: "jira:issue_updated" },
      },
      {
  ...
  },
  {
    ...
    color: "#1A82E2",
    description:
      "Send transactional and marketing emails at scale using SendGrid's reliable email delivery infrastructure.",
    icon: "SG",
    certificationLevel: "verified",
    authType: "apikey",
    isInstalled: false,
    ...
    actions: [
      ...
      },
      {
        ...
        description: "Send a SendGrid dynamic template email",
        inputSchema: {
          type: "object",
          properties: {
            to: { type: "string" },
      ...
      },
      {
        ...
        description: "Add or update a contact in a SendGrid marketing list",
        inputSchema: {
          type: "object",
          properties: {
            email: { type: "string" },
  ...
  },
  {
    ...
    color: "#47A248",
    description:
      "Read and write documents in MongoDB Atlas. Supports complex queries, aggregation pipelines, and change stream polling.",
    icon: "Mg",
    ...
    actions: [
      ...
      },
      {
        ...
        name: "Find Documents",
        description: "Query documents with a filter",
        inputSchema: {
          type: "object",
          properties: {
            database: { type: "string" },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            collection: { type: "string" },
            filter: { type: "object" },
            deleteMany: { type: "boolean", default: false },
          },
    ...
    triggers: [
      {
        triggerId: "new_document",
        triggerType: "polling",
        name: "New Document Added",
        description: "Polls for newly inserted documents",
        config: { sortField: "_id" },
        pollingInterval: 60,
      },
      {
        triggerId: "document_changed",
        triggerType: "polling",
        name: "Document Changed",
        description: "Polls for recently updated documents",
        config: { sortField: "updatedAt" },
        pollingInterval: 120,
      },
    ],
  },
  {
    ...
    color: "#FF5A5F",
    description:
      "Create, read, update and delete records in Airtable bases. Great for managing structured data without a database.",
    icon: "At",
    certificationLevel: "community",
    authType: "apikey",
    isInstalled: false,
    ...
    triggers: [
      {
        triggerId: "new_record",
        triggerType: "polling",
        name: "New Record Created",
        description: "Polls for newly created records in a table",
        config: {},
        pollingInterval: 300,
      },
      {
        ...
        triggerType: "polling",
        name: "Record Updated",
        description: "Polls for recently modified records",
        config: {},
        pollingInterval: 300,
      },
    ],
  },
  {
    ...
    color: "#000000",
    description:
      "Create and update Notion pages, query databases, and build wikis. Connect Notion to your automation workflows.",
    icon: "No",
    certificationLevel: "verified",
    authType: "oauth2",
    isInstalled: false,
    ...
    actions: [
      ...
      },
      {
        ...
        name: "Update Page",
        description: "Update properties or content of a Notion page",
        inputSchema: {
          type: "object",
          properties: {
            pageId: { type: "string" },
    ...
    triggers: [
      {
        ...
        description: "Polls for newly created pages in a database",
        config: {},
        pollingInterval: 600,
      },
      {
        triggerId: "database_updated",
        triggerType: "polling",
        name: "Database Updated",
        description: "Polls for recently changed database entries",
        config: {},
        pollingInterval: 600,
      },
    ],
  },
  {
    ...
    color: "#96BF48",
    description:
      "Manage products, process orders, and sync inventory with your Shopify store. Automate e-commerce operations.",
    icon: "Sh",
    certificationLevel: "verified",
    authType: "oauth2",
    isInstalled: false,
    ...
    actions: [
      {
        ...
        name: "Create Product",
        description: "Create a new product listing in your Shopify store",
        inputSchema: {
          type: "object",
          properties: {
            title: { type: "string" },
      ...
      },
      {
        ...
        name: "Fulfill Order",
        description: "Mark an order as fulfilled and provide tracking",
        inputSchema: {
          type: "object",
          properties: {
            orderId: { type: "string" },
      ...
      },
      {
        ...
        description: "Set inventory levels for a product variant",
        inputSchema: {
          type: "object",
          properties: {
    ...
    triggers: [
      {
        ...
        triggerType: "webhook",
        name: "Order Created",
        description: "Fires when a new order is placed in your store",
        config: { topic: "orders/create" },
      },
      {
        triggerId: "payment_received",
        triggerType: "webhook",
        name: "Payment Received",
        description: "Fires when payment is captured for an order",
        config: { topic: "orders/paid" },
      },
      {
        triggerId: "fulfillment_updated",
        triggerType: "webhook",
        name: "Fulfillment Updated",
        description: "Fires when a fulfillment status changes",
        config: { topic: "fulfillments/update" },
      },
    ],
  },
];
...
async function seedConnectors() {
  ...
  const existingActions = await db
    .select({ id: connectorActionsTable.id })
  ...
  for (const seed of CONNECTOR_SEEDS) {
    ...
    const [inserted] = await db
      ...
      .values({
        ...connectorData,
        sdkVersion: connectorData.sdkVersion ?? "1.0",
      })
      .returning();

    if (actions.length > 0) {
      await db
        .insert(connectorActionsTable)
        .values(actions.map((a) => ({ ...a, connectorId: inserted.id })));
    }
    if (triggers.length > 0) {
      await db
        .insert(connectorTriggersTable)
        .values(triggers.map((t) => ({ ...t, connectorId: inserted.id })));
    }

    // Seed some mock execution history
    const mockStatuses: ("success" | "failed" | "timeout")[] = [
      "success",
      "success",
      "success",
      "success",
...
router.get("/connectors", async (req, res): Promise<void> => {
  ...
  if (q.certificationLevel)
    conditions.push(
      eq(connectorsTable.certificationLevel, q.certificationLevel),
    );
...
router.get("/connectors/executions", async (req, res): Promise<void> => {
  ...
  const conditions = [];
  if (connectorId)
    conditions.push(eq(connectorExecutionsTable.connectorId, connectorId));
