...
export const ForkTemplateResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "description": zod.string(),
  "category": zod.string(),
...
export const DuplicateWorkflowResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "description": zod.string().nullish(),
  "status": zod.enum(['active', 'inactive', 'draft']),
...
export const GetUsageSummaryResponse = zod.object({
  ...
  "includedExecutions": zod.number().nullish()
})
...
export const PromoteWorkflowResponse = zod.object({
  "id": zod.number(),
  "workflowId": zod.number(),
  "workflowName": zod.string(),
  "fromEnvironment": zod.string(),
...
export const RetryDlqEntryResponse = zod.object({
  "id": zod.number(),
  "workflowId": zod.number(),
  "workflowName": zod.string(),
  "status": zod.enum(['running', 'success', 'failed', 'cancelled']),
...
export const RetryExecutionResponse = zod.object({
  "id": zod.number(),
  "workflowId": zod.number(),
  "workflowName": zod.string(),
  "status": zod.enum(['running', 'success', 'failed', 'cancelled']),
...
export const AddPermissionToRoleResponse = zod.void()
...
export const RemovePermissionFromRoleResponse = zod.void()
...
export const RevokeRoleResponse = zod.void()
...
export const DeleteFeatureFlagResponse = zod.void()
...
export const CreateRegionPolicyResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "region": zod.string(),
  "tier": zod.enum(['standard', 'premium', 'edge']),
...
export const DeleteRegionPolicyResponse = zod.void()
...
export const ListSchedulesResponseItem = zod.object({
  ...
  "name": zod.string(),
  "description": zod.string().nullish(),
  "interval": zod.enum(['once', 'recurring', 'cron']),
...
export const CreateScheduleBody = zod.object({
  ...
  "maxRuns": zod.number().optional(),
  "retryOnFailure": zod.boolean().optional(),
 ...
 */
export const GetDueSchedulesResponseItem = zod.object({
  "id": zod.number(),
  "tenantId": zod.number(),
  "workflowId": zod.number(),
  "name": zod.string(),
...
export const GetDueSchedulesResponse = zod.array(GetDueSchedulesResponseItem)


/**
 * @summary Get schedule statistics
 */
export const GetScheduleStatsResponse = zod.object({
 ...
 */
export const ActivateScheduleParams = zod.object({
  "id": zod.coerce.number()
})

export const ActivateScheduleResponse = zod.object({
  "id": zod.number(),
  "tenantId": zod.number(),
  "workflowId": zod.number(),
  "name": zod.string(),
...
export const ListDataSourcesResponseItem = zod.object({
  ...
  "name": zod.string(),
  "description": zod.string().nullish(),
  "kind": zod.enum(['postgresql', 'mysql', 'mongodb', 'rest_api', 'graphql', 'bigquery', 'snowflake', 'csv_upload', 'custom']),
  "config": zod.object({

}).passthrough().optional(),
  "status": zod.enum(['active', 'inactive', 'error', 'testing']),
 ...
 */
export const ListDataSourceAdaptersResponseItem = zod.string()
export const ListDataSourceAdaptersResponse = zod.array(ListDataSourceAdaptersResponseItem)
 ...
 */
export const ExecuteDataSourceQueryParams = zod.object({
  "id": zod.coerce.number()
})

export const ExecuteDataSourceQueryBody = zod.object({
  "query": zod.string()
})

export const ExecuteDataSourceQueryResponse = zod.object({
 ...
 */
export const ListDataSourceTablesParams = zod.object({
  "id": zod.coerce.number()
})

export const ListDataSourceTablesResponseItem = zod.string()
export const ListDataSourceTablesResponse = zod.array(ListDataSourceTablesResponseItem)
