...
// Counters
export const connectorInstallsCounter = meter.createCounter(
  "connector.installs",
  {
...
export const connectorExecutionsCounter = meter.createCounter(
...
// Histograms
export const connectorExecutionDurationHistogram = meter.createHistogram(
...
// Gauges
export const activeConnectorInstallsGauge = meter.createGauge(
  "connector.installs.active",
  {
...
export function recordConnectorInstall(
  ...
  connectorInstallsCounter.add(1, {
