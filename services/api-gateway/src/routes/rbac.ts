...
const SYSTEM_PERMISSIONS = [
  ...
  { resource: "ai", action: "read", description: "View AI models and prompts" },
  {
    resource: "ai",
    action: "write",
    description: "Manage AI prompts and models",
  },
  ...
  { resource: "audit", action: "read", description: "View audit log" },
  {
    resource: "executions",
    action: "read",
    description: "View executions and DLQ",
  },
  {
    resource: "executions",
    action: "run",
...
const SYSTEM_ROLES = [
  {
    name: "Owner",
    description:
      "Workspace owner — full access including billing, workspace deletion, and ownership transfer",
  },
  {
    name: "Admin",
    description:
      "Workspace administrator — full access except billing and workspace management",
  },
  {
    name: "Builder",
    description:
      "Power user — create and edit workflows, dashboards, and AI agents",
  },
  {
    name: "Viewer",
...
async function ensureRbacSeed() {
  ...
  for (const a of assignments) {
    await prisma.rolePermission.create({ data: a }).catch(() => {
    ...
    res.json(
      members.map((m) => ({
        ...
        lastLoginAt: m.lastLoginAt
          ? m.lastLoginAt instanceof Date
            ? m.lastLoginAt.toISOString()
            : new Date(m.lastLoginAt).toISOString()
          : null,
