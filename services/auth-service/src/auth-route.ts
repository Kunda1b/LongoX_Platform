...
import { db, usersTable, tenantsTable } from "@autoflow/db";
...
async function ensureSeedUser() {
  ...
  await db.insert(usersTable).values([
    { email: "admin@flowbuilder.io", passwordHash: hash, name: "Admin User", tenantId: tenantId ?? undefined, role: "admin" },
    { email: "editor@flowbuilder.io", passwordHash: hash, name: "Editor User", tenantId: tenantId ?? undefined, role: "editor" },
    { email: "viewer@flowbuilder.io", passwordHash: hash, name: "Viewer User", tenantId: tenantId ?? undefined, role: "viewer" },
  ]);
}
