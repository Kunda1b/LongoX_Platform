...
// Counters
export const notificationsSentCounter = meter.createCounter(
  "notifications.sent",
  {
...
export const notificationsFailedCounter = meter.createCounter(
...
// Histograms
export const notificationDurationHistogram = meter.createHistogram(
...
// Gauges
export const pendingNotificationsGauge = meter.createGauge(
