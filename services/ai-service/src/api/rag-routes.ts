...
router.post(
  "/api/rag/knowledge-bases/:id/documents",
  authorize("ai:write"),
  requireTenantContext,
  async (req, res): Promise<void> => {
    const tenantId = (req as any).tenantId;
...
router.delete(
  "/api/rag/knowledge-bases/:id/documents/:docId",
  authorize("ai:write"),
  requireTenantContext,
  async (req, res): Promise<void> => {
    const tenantId = (req as any).tenantId;
...
router.post(
  "/api/rag/knowledge-bases/:id/search",
  authorize("ai:read"),
  requireTenantContext,
  async (req, res): Promise<void> => {
    const tenantId = (req as any).tenantId;
    ...
    const results = hybrid
      ? await vectorSearchService.hybridSearch(kbId, query, {
          topK,
          minScore,
          filter,
        })
      : await vectorSearchService.search(kbId, query, {
          topK,
          minScore,
          filter,
        });
...
router.post(
  "/api/rag/knowledge-bases/:id/query",
  authorize("ai:write"),
  requireTenantContext,
  async (req, res): Promise<void> => {
    const tenantId = (req as any).tenantId;
...
router.post(
  "/api/rag/knowledge-bases/:id/reindex",
  authorize("ai:write"),
  requireTenantContext,
  async (req, res): Promise<void> => {
    const tenantId = (req as any).tenantId;
