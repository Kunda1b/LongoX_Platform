...
// Histograms
export const auditQueryDurationHistogram = meter.createHistogram("audit.query.duration", {
  description: "Audit query duration in milliseconds",
  unit: "ms",
});

// Gauges
export const auditEventsPerMinuteGauge = meter.createGauge("audit.events.per_minute", {
...
export function recordAuditEvent(
  ...
  auditEventsCounter.add(1, { action, resource_type: resourceType, actor_type: actorType });
}
