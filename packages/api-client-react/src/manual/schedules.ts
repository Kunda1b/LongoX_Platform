...
export const listSchedules = async (params?: ListSchedulesParams, options?: RequestInit): Promise<Schedule[]> => {
  ...
  return customFetch<Schedule[]>(`${getListSchedulesUrl()}${qs ? `?${qs}` : ""}`, { ...options, method: "GET" });
};

export const getSchedule = async (id: number, options?: RequestInit): Promise<Schedule> => {
  return customFetch<Schedule>(getScheduleUrl(id), { ...options, method: "GET" });
};

export const createSchedule = async (input: ScheduleInput, options?: RequestInit): Promise<Schedule> => {
...
export const updateSchedule = async (id: number, input: Partial<ScheduleInput>, options?: RequestInit): Promise<Schedule> => {
...
export const getDueSchedules = async (options?: RequestInit): Promise<Schedule[]> => {
  return customFetch<Schedule[]>(getDueSchedulesUrl(), { ...options, method: "GET" });
};

export const getScheduleStats = async (options?: RequestInit): Promise<ScheduleStats> => {
  return customFetch<ScheduleStats>(getScheduleStatsUrl(), { ...options, method: "GET" });
};

export const pauseSchedule = async (id: number, options?: RequestInit): Promise<Schedule> => {
  return customFetch<Schedule>(getPauseScheduleUrl(id), { ...options, method: "POST" });
};
...
export const getScheduleQueryKey = (id: number) => [`/api/schedules/${id}`] as const;
...
export function useListSchedules<TData = Schedule[], TError = ErrorType<unknown>>(
  ...
  options?: { query?: UseQueryOptions<Schedule[], TError, TData>; request?: RequestInit },
) {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = queryOptions?.queryKey ?? getListSchedulesQueryKey(params);
  const queryFn = ({ signal }: { signal?: AbortSignal }) => listSchedules(params, { signal, ...requestOptions });
...
export function useGetSchedule<TData = Schedule, TError = ErrorType<void>>(
  ...
  const queryFn = ({ signal }: { signal?: AbortSignal }) => getSchedule(id, { signal, ...requestOptions });
  const query = useQuery({ queryKey, queryFn, enabled: !!id, ...queryOptions }) as any;
  return { ...query, queryKey };
}

export function useDueSchedules<TData = Schedule[], TError = ErrorType<unknown>>(
  options?: { query?: UseQueryOptions<Schedule[], TError, TData>; request?: RequestInit },
) {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = queryOptions?.queryKey ?? getDueSchedulesQueryKey();
  const queryFn = ({ signal }: { signal?: AbortSignal }) => getDueSchedules({ signal, ...requestOptions });
  const query = useQuery({ queryKey, queryFn, ...queryOptions }) as any;
  return { ...query, queryKey };
}

export function useScheduleStats<TData = ScheduleStats, TError = ErrorType<unknown>>(
  options?: { query?: UseQueryOptions<ScheduleStats, TError, TData>; request?: RequestInit },
) {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = queryOptions?.queryKey ?? getScheduleStatsQueryKey();
  const queryFn = ({ signal }: { signal?: AbortSignal }) => getScheduleStats({ signal, ...requestOptions });
  const query = useQuery({ queryKey, queryFn, ...queryOptions }) as any;
  return { ...query, queryKey };
}
...
export function useUpdateSchedule<TError = ErrorType<unknown>>(
  options?: UseMutationOptions<Schedule, TError, { id: number; data: Partial<ScheduleInput> }>,
) {
  const queryClient = useQueryClient();
  return useMutation({
