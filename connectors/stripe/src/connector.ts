...
export const stripeConnector: ConnectorDefinition = {
  ...
  actions: [
    {
      ...
      inputSchema: { email: "string", name: "string?", description: "string?" },
    ...
    },
    {
      ...
      outputSchema: { id: "string", amount: "number", status: "string" },
      idempotent: true,
    },
    {
  ...
  triggers: [
    ...
    },
    {
      ...
      type: "webhook",
      outputSchema: { customerId: "string", email: "string" },
    },
  ],
  permissions: [
    "customers.read",
...
connectorRegistry.registerAction("stripe", {
  definition: stripeConnector.actions[0],
  handler: createCustomer,
});
connectorRegistry.registerAction("stripe", {
  definition: stripeConnector.actions[1],
  handler: createInvoice,
});
connectorRegistry.registerAction("stripe", {
  definition: stripeConnector.actions[2],
  handler: createPaymentIntent,
});
connectorRegistry.registerAction("stripe", {
  definition: stripeConnector.actions[3],
  handler: createProduct,
});
connectorRegistry.registerTrigger("stripe", {
  definition: stripeConnector.triggers[0],
  handler: paymentSucceeded,
});
connectorRegistry.registerTrigger("stripe", {
  definition: stripeConnector.triggers[1],
  handler: invoicePaid,
});
connectorRegistry.registerTrigger("stripe", {
  definition: stripeConnector.triggers[2],
