...
export async function contactUpdated(context: TriggerContext): Promise<TriggerEvent[]> {
  return [createTriggerEvent("hubspot.contactUpdated", {
...
export async function dealUpdated(context: TriggerContext): Promise<TriggerEvent[]> {
  return [createTriggerEvent("hubspot.dealUpdated", {
