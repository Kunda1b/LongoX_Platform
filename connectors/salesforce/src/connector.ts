  ...
  actions: [
    {
      ...
      inputSchema: { objectType: "string", data: "object" },
    ...
    },
    {
      ...
      inputSchema: { objectType: "string", recordId: "string", data: "object" },
...
connectorRegistry.registerAction("salesforce", {
  definition: salesforceConnector.actions[0],
  handler: createRecord,
});
connectorRegistry.registerAction("salesforce", {
  definition: salesforceConnector.actions[1],
  handler: updateRecord,
});
connectorRegistry.registerAction("salesforce", {
  definition: salesforceConnector.actions[2],
  handler: queryRecords,
});
connectorRegistry.registerTrigger("salesforce", {
  definition: salesforceConnector.triggers[0],
  handler: recordCreated,
});
connectorRegistry.registerTrigger("salesforce", {
  definition: salesforceConnector.triggers[1],
  handler: recordUpdated,
});
